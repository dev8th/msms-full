    ...
    $.ajax({
        ...
        success: function(msg) {
            let num=0,
                ...
                json = JSON.parse(msg),
                typeId = $(".btn-select").attr("id"),
                subTotals = [],itemTotals = [],kgTotals = [],diskonTotals = [],
                timeout=0;
            ...
            if(fcSymbol!=""){
                ...
                $("#"+modalId+" input[name='convertToSGD']").attr("checked",true);
...
function onChangeSatuanBerat(a){
    ...
    if(val=="KG"){
        ...
        $("#"+modalId+" #"+serviceElementId+" .col-volume,#"+modalId+" #"+serviceElementId+" .col-item,#"+modalId+" #"+serviceElementId+" .col-actual").hide();
        $("#"+modalId+" #"+serviceElementId+" input[name='kg[]']").attr("required",true);
        $("#"+modalId+" #"+serviceElementId+" input[name='kg[]']").attr("readonly",false);
        $("#"+modalId+" #"+serviceElementId+" input[name='panjang[]'],#"+modalId+" #"+serviceElementId+" input[name='lebar[]'],#"+modalId+" #"+serviceElementId+" input[name='tinggi[]'],#"+serviceElementId+" input[name='item[]'],#"+modalId+" #"+serviceElementId+" input[name='actualKg[]']").attr("required",false);
        ...
        $("#"+modalId+" #"+serviceElementId+" input[name='item[]'],#"+modalId+" #"+serviceElementId+" input[name='kg[]']").attr("required",false);
        ...
        $("#"+modalId+" #"+serviceElementId+" .col-volume,#"+modalId+" #"+serviceElementId+" .col-kg,#"+modalId+" #"+serviceElementId+" .col-actual").hide();
        $("#"+modalId+" #"+serviceElementId+" input[name='item[]']").attr("required",true);
        $("#"+modalId+" #"+serviceElementId+" input[name='panjang[]'],#"+modalId+" #"+serviceElementId+" input[name='lebar[]'],#"+modalId+" #"+serviceElementId+" input[name='tinggi[]'],#"+modalId+" #"+serviceElementId+" input[name='kg[]'],#"+modalId+" #"+serviceElementId+" input[name='actualKg[]']").attr("required",false);
