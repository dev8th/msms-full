...
<table cellspacing="0" border="1">
    ...
    <tr>
        <td colspan=8 height="17" align="center" valign=middle class="middle text-align-center"><font size="5">(REFERENCE : <?php echo $reference!=""?$reference:"-"?>)</font></td>
    </tr>
    <tr>
        <th>No</th>
    ...
    @foreach($list as $a)
        ...
        <tr>
            ...
            <td rowspan="3" align="center" valign=middle class="middle text-align-center">{{$a->weight}}</td>
            <td rowspan="3" align="center" valign=middle class="middle text-align-center">{{$a->item}}</td>
            <td rowspan="3" align="right" valign=middle class="middle text-align-right"><?php echo $a->item > 0 ? App\Http\Controllers\Controller::rupiah($a->item * $a->service_price_per) : App\Http\Controllers\Controller::rupiah(App\Http\Controllers\Controller::pembulatan($a->weight) * $a->service_price_per) ?></td>
        </tr>
        <tr></tr>
        <tr></tr>
        <tr>
