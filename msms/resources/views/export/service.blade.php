...
<table cellspacing="0" border="1">
    <tr>
        <th colspan=<?php echo Auth::user()->servlist_nom ? "10" : "7" ?> height="17" align="center" valign=middle class="middle text-align-center"><font size="5">DATA SERVICE LIST | {{$tanggal}}</font></th>
    </tr>
    <tr>
