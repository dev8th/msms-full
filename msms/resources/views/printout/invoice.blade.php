                ...
                <table width="100%" class="total" style="line-height: 22px;margin-top:20px;border-spacing: 0;">
                    <thead>
                        <tr style="text-align:left">
                            ...
                            <th style="border-top:1px solid black;border-bottom:1px solid black">Kg/Item</th>
                    ...
                    <tbody>
                        ...
                        <tr style="border-top:1px solid #d5d5d5;">
                            ...
                            <td style="text-align: right;vertical-align:top"><?php echo $g->item > 0 ? ($fc_symbol==""? App\Http\Controllers\Controller::rupiah($g->item * $g->service_price_per) : "S$ ".round($g->item*$g->service_price_per/$fc_value,2)) : ($fc_symbol==""? App\Http\Controllers\Controller::rupiah(App\Http\Controllers\Controller::pembulatan($g->weight) * $g->service_price_per) : "S$ ".round(App\Http\Controllers\Controller::pembulatan($g->weight) * $g->service_price_per/$fc_value,2)) ?></td>
                        </tr>
