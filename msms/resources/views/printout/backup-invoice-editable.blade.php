    ...
    <div class="container">
        <div class="wrapper">
            <div class="printout">
                ...
                <table width="100%" class="total" style="line-height: 25px;margin-top:20px;border-spacing: 0;">
                    <thead>
                        <tr style="text-align:left">
                            @if($custTypeId=="COR")
                            <th style="border-top:1px solid black;border-bottom:1px solid black">Penerima</th>
                            @endif
                            <th style="border-top:1px solid black;border-bottom:1px solid black">Warehouse</th>
                    ...
                    <tbody>
                        ...
                        @if($custTypeId=="COR")
                        <tr>
                            <td rowspan="{{$rowspan+1}}" style="text-align: left;vertical-align:top;border-bottom:1px solid black">
                        ...
                        @endif
                        <tr>
                            <td rowspan="{{$rowspan}}" style="text-align: left;vertical-align:top;border-bottom:1px solid black">
                        ...
                        <tr>
                            <td class="bold-text" style="text-align: left;vertical-align:top">{{$g->serviceName}}</td>
                            <td style="text-align: left;vertical-align:top">{{App\Http\Controllers\Controller::rupiah($g->service_price_per)}}</td>
                            <td rowspan="{{$rowspan-2}}" style="text-align: left;vertical-align:top"><?php echo $g->length > 0 ? "<div>" . App\Http\Controllers\Controller::pembulatan($g->weight) . " Kg</div><div>Dimensi : " . $g->length . "x" . $g->width . "x" . $g->height . "</div><div>Aktual : ".$g->actual_weight." Kg</div>" : ($g->item > 0 ? $g->item . " Item" : ($g->weight > 0 ? App\Http\Controllers\Controller::pembulatan($g->weight) . " Kg" : "")) ?></td>
                        ...
                        <tr>
                            <td>Packing Kayu {{empty($g->packing_desc)?"":"(".$g->packing_desc.")"}}</td>
                            <td></td>
                        ...
                        <tr>
                            <td>Import Permit {{empty($g->import_permit_desc)?"":"(".$g->import_permit_desc.")"}}</td>
                            <td></td>
                        ...
                        <tr>
                            <td>Document {{empty($g->document_desc)?"":"(".$g->document_desc.")"}}</td>
                            <td></td>
                        ...
                        <tr>
                            <td>DR Medicine {{empty($g->dr_medicine_desc)?"":"(".$g->dr_medicine_desc.")"}}</td>
                            <td></td>
                        ...
                        <tr>
                            <td>Asuransi {{"(Harga Barang ".App\Http\Controllers\Controller::rupiah($g->insurance_item_price).")"}}</td>
                            <td></td>
                        ...
                        <tr>
                            <td>Tax {{"(Harga Barang ".App\Http\Controllers\Controller::rupiah($g->tax_item_price).")"}}</td>
                            <td></td>
                        ...
                        <tr>
                            <td>Fee {{"(Harga Barang ".App\Http\Controllers\Controller::rupiah($g->fee_item_price).")"}}</td>
                            <td></td>
                        ...
                        <tr>
                            <td>Extra Ongkir <?php echo $g->extra_cost_dest!=""?"- ".$g->extra_cost_dest:""?> <?php echo $g->extra_cost_vendor_name!=""?"- ".$g->extra_cost_vendor_name:""?></td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom:1px solid black"></td>
                            <td class="bold-text" style="border-bottom:1px solid black">Sub Total</td>
                            <td class="bold-text" style="border-bottom:1px solid black;text-align:right">{{App\Http\Controllers\Controller::rupiah($g->sub_total)}}</td>
                        </tr>
                        @endforeach
                        <tr>
                            @if($custTypeId=="COR")
