...
class Controller extends BaseController
{
    ...
    public static function hitungBeratWare($wh,$type,$mismass_invoice_id=""){
        ...
        return number_format((float)$a->totalWeight, 2, '.', '');
    }
    ...
    public function createDescForResi($mismassInvoiceId){
        ...
        Total Berat : <b>".number_format((float)$getTotalData->totalBerat, 2, '.', '')." Kg</b><br>
        ...
        foreach($getDataList as $g){
            ...
            No. Resi : <b>".$g->shipping_number."</b><br>
            </div>
            <br>";
    ...
    public function createDescForEditResi($newData){
        ...
        for($i = 0; $i <= count($newData->input("id")) - 1; $i++){
            ...
            Nama Kurir : <b>".($newData->input('tipeForwarder')[$i] ? $newData->input('namaForwarder')[$i] ?? "" : "-")."</b><br>
            No. Resi : <b>".$newData->input('noResi')[$i]."</b><br>
            </div>
            <br>";
