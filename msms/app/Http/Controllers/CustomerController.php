...
class CustomerController extends Controller
{
    ...
    public function table(string $custTypeId, Request $request)
    {
        ...
        if ($custTypeId == "IND") {
            ...
            foreach ($lists as $list) {
                ...
                $row[] = "<div>".number_format((float)$this->hitungBeratCust($list->id,0), 2, '.', '')." Kg</div><div>".$this->hitungItemCust($list->id,0)." Item</div>";
                
                if(Auth::user()->custlist_nom){
                    $row[] = "<div style='font-weight:700'>".$this->rupiah($this->hitungLabaCust($list->id,0))."</div>";
                }

                $row[] = $list->reference!=""?$list->reference:"-";
    ...
    public function tambah(Request $request)
    {
        ...
        $dataHistory=[
            ...
            Reference : <b>".$request->input('reference')."</b><br>
    ...
    public function hapus(Request $request)
    {
        ...
        $dataHistory=[
            ...
            Reference : <b>".$lawas->reference."</b><br>
    ...
    public function edit(Request $request)
    {
        ...
        $dataHistory=[
            ...
            ID : <b>".$lawas->id."</b><br>
            Tipe : <b>".DB::table("cust_type_list")->where("id", $lawas->cust_type_id)->value("name")."</b><br>
            Reference : ".($lawas->reference==$request->input('reference')?"<b>".$request->input('reference')."</b><br>":"<b style='color:red'>".$lawas->reference."</b> <i class='fas fa-arrow-right'></i> <b style='color:red'>".$request->input('reference')."</b><br>")."
