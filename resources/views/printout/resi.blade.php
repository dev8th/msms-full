...
<body>
    <div class="container">
        ...
        $shippingNumberStats = $g->shipping_number_stats;
                ...
                <div class="element">
                    ...
                    <table style="border-bottom:none;">
                        <tr style="text-align: center;border-bottom:none;">
                            ...
                            <td style="width:60%;font-size:20px;border-bottom:none;"><?php echo $shippingNumberStats ? "ID" : "Resi" ?> : <div style="display: inline;font-weight:700">{{$shippingNumber}}</div>
                            </td>
                        </tr>
                    </table>
                    <table style="border-bottom:none;">
