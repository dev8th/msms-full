...
@endphp
	...
	<table cellspacing="0" border="1">
		...
		<tr>
			...
			<td align="center" valign=middle class="middle text-align-center">{{$d->cons_first_name." ".$d->cons_middle_name." ".$d->cons_last_name}}<br>Reference : <?php echo $d->reference!=""?App\Http\Controllers\Controller::getReferenceFullName($d->reference):"-"?></td>
			...
			<td align="center" valign=middle class="middle text-align-center">{{round(App\Http\Controllers\Controller::hitungTotalBeratByInvoice($d->mismass_invoice_id),2)}} Kg<br>{{App\Http\Controllers\Controller::hitungTotalItemByInvoice($d->mismass_invoice_id)}} Item<br>0 CBM</td>
